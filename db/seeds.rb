...
Item.find_by(name: "チョコレートソースケーキ").image.attach(io: sato_cake2_image, filename: '溶けかけているチョコケーキ.jpg', content_type: 'image/*')
...
Item.find_by(name: "いちごのタルト").image.attach(io: sato_cake3_image, filename: 'イチゴのタルト.jpg', content_type: 'image/*')
